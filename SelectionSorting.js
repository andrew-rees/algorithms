...
while (massiveList.length != 0) {
    var smallest = Math.min(...massiveList);
    var index = massiveList.indexOf(smallest)
    massiveList.splice(index, 1);
    result.push(smallest)
    //console.log(`Messy list: ${massiveList}`)
